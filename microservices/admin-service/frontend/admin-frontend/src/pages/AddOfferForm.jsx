  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-offWhite">
      <form
        ...
        className="bg-offWhite p-6 rounded-2xl shadow-md w-full max-w-2xl border-2 border-oliveGreen"
      >
        <h2 className="text-5xl font-bold bg-gradient-to-r from-emerald-700 via-lime-500 to-green-800 bg-clip-text text-transparent font-kalnia text-center mb-6">
          Add Offer
        </h2>
