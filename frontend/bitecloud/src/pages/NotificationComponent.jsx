...
const NotificationComponent = ({ userId }) => {
    ...
    useEffect(() => {
        ...
        const fetchNotifications = async () => {
            try {
                const res = await axios.get('http://localhost:5200/api/notification/retriveNotification/123');
        ...
        const checkNotificationSeenSatus = async() =>{
            ...
            const notifications = await axios.get('http://localhost:5200/api/notification/retrieveSeenNotificationList/123');
